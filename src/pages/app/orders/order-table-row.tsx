...
export function OrderTableRow({ order }: OrderTableRowProps) {
  ...
  const { mutateAsync: aproveOrderFn, isPending: isApproveingOrder } =
    useMutation({
    ...
    <TableRow>
      ...
      <TableCell>
        ...
        {order.status === 'processing' && (
          ...
          >
            <ArrowRight className="mr-2 flex h-3 w-3" />
            <span className="mb-0.5">Em entrega</span>
          </Button>
        )}
        ...
        {order.status === 'delivering' && (
          ...
          >
            <ArrowRight className="mr-2 flex h-3 w-3" />
            <span className="mb-0.5">Entregue</span>
          </Button>
        )}
      </TableCell>
      ...
      <TableCell>
        <Button
          disabled={
            !['pending', 'procesing'].includes(order.status) || isCancelingOrder
          }
